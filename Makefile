NAME = so_long
SRC = main.c keyhook.c check_map.c check_map2.c check_map3.c display_map.c movement.c animation.c dolphin_moves.c free_my_game.c attack.c movement2.c init_game.c \
