...
/*   Updated: 2023/12/26 19:22:06 by idhaimy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_player_right(t_program *prg)
{
	...
	{
		number = ft_itoa(i);
		ft_strlcpy(file_path, "./animation/player/idle_right/idle",
			sizeof(file_path));
...
void	init_player_left(t_program *prg)
{
	...
	{
		number = ft_itoa(i);
		ft_strlcpy(file_path, "./animation/player/idle_left/idle",
			sizeof(file_path));
		ft_strlcat(file_path, number, sizeof(file_path));
		ft_strlcat(file_path, ".xpm", sizeof(file_path));
		prg->player_anim.frames_arr[i] = mlx_xpm_file_to_image(prg->mlx,
...
void	init_player_attack_right(t_program *prg)
{
	...
	{
		number = ft_itoa(i);
		ft_strlcpy(file_path, "./animation/player/attack_right/attack",
			sizeof(file_path));
		ft_strlcat(file_path, number, sizeof(file_path));
		ft_strlcat(file_path, ".xpm", sizeof(file_path));
		prg->player_anim.frames_arr[i] = mlx_xpm_file_to_image(prg->mlx,
...
void	init_player_attack_left(t_program *prg)
{
	...
	{
		number = ft_itoa(i);
		ft_strlcpy(file_path, "./animation/player/attack_left/attack",
			sizeof(file_path));
		ft_strlcat(file_path, number, sizeof(file_path));
		ft_strlcat(file_path, ".xpm", sizeof(file_path));
		prg->player_anim.frames_arr[i] = mlx_xpm_file_to_image(prg->mlx,
